    ...
    <div className="bg-white">
      <div className="bg-navy-950 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-steel-400 max-w-xl leading-relaxed">
            Kostenloses Angebot, Fragen zu unseren Leistungen oder Mietanfragen –
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            <h2 className="text-xl font-black text-navy-950 mb-8">Direkt erreichbar</h2>
            <div className="space-y-5">
              <a
                href="tel:+493377202730"
                className="flex items-start gap-4 p-5 rounded-xl border border-steel-200 hover:border-ice-300 transition-colors group"
              >
          ...
          <div>
            <h2 className="text-xl font-black text-navy-950 mb-8">Angebot anfordern</h2>
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-steel-200 rounded-lg text-sm focus:outline-none focus:border-ice-400 transition-colors"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-navy-900 mb-1.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    placeholder="Beschreiben Sie kurz, was gereinigt werden soll, welche Fläche/Objekt, und welcher Zeitraum gewünscht ist..."
                    className="w-full px-4 py-2.5 border border-steel-200 rounded-lg text-sm focus:outline-none focus:border-ice-400 transition-colors resize-none"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-ice-500 text-white font-bold rounded-md hover:bg-ice-400 transition-colors text-sm"
                >
                  Anfrage absenden
                  <ArrowRight size={15} />
                </button>
